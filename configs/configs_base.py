...
basic_configs = {
    "project": 'Complex_train',
    "run_name": "Complex_test",
    "base_dir": './output',
    # training
    "eval_interval": 400,
    "log_interval": 50,
    ...
    "eval_only": False,
    "load_checkpoint_path": "/mnt/rna01/lzy/Protenix/release_model/model_v0.2.0.pt",
...
model_configs = {
    ...
    "diffusion_chunk_size": ValueMaybeNone(1),  # chunksize of diffusion_batch_size
    ...
    "skip_amp": {
        ...
        # "sample_diffusion_training": False,
        # "loss": False,
    },
    "infer_setting": {
    ...
    "model": {
        ...
        'ouroboros':{
            'model_path': '/mnt/rna01/lzy/Protenix/Ouroboros',
            'threads': 16,
            'cache': False,
        },
        'docking':{
