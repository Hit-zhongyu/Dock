...
default_weighted_pdb_configs = {
    ...
    "cropping_configs": {
        ...
        "method_weights": ListValue([0.0, 0.0, 1.0]),
...
DATA_ROOT_DIR = os.environ.get("PROTENIX_DATA_ROOT_DIR", "/mnt/dna01/library-seq/af3_db_v2/af3-dev/release_data")
...
data_configs = {
    ...
    "smiles_emb_path": "/mnt/rna01/lzy/Protenix/smiles_embedding_dict.pkl",
    "weightedPDB_before2109_wopb_nometalc_0925": {
        "base_info": {
            ...
            "mmcif_dir": os.path.join(DATA_ROOT_DIR, "train_mmcif"),
            "bioassembly_dict_dir": os.path.join(DATA_ROOT_DIR, "train_pkl"),
            "indices_fpath": os.path.join(
                DATA_ROOT_DIR,
                # "indices/weightedPDB_indices_before_2021-09-30_wo_posebusters_resolution_below_9.csv.gz",
                # "indices/ligand_prot_interactions.csv.gz",
                "indices/training_data_filter_index.csv.gz",
            ),
            "pdb_list": "",
            ...
            # "ouroboros_pt_path": "/mnt/rna01/lzy/Protenix/Ouroboros",
            # "ouroboros_threads": 10,
        },
        **deepcopy(default_weighted_pdb_configs),
    },
    "recentPDB_1536_sample384_0925": {
        "base_info": {
            "mmcif_dir": os.path.join(DATA_ROOT_DIR, "recentPDB_mmcif"),
            "bioassembly_dict_dir": os.path.join(
                DATA_ROOT_DIR, "recentPDB_bioassembly_new"
            ),
            "indices_fpath": os.path.join(
                DATA_ROOT_DIR, "indices/recentPDB_valid_filter.csv"
            ),
    ...
    "posebusters_0925": {
        "base_info": {
            ...
            "bioassembly_dict_dir": os.path.join(
                DATA_ROOT_DIR, "posebusters_pkl"
            ),
            "indices_fpath": os.path.join(
                # DATA_ROOT_DIR, "indices/posebusters_indices_mainchain_interface.csv"
                DATA_ROOT_DIR, "indices/posebusters_valid_filter.csv"
            ),
            "pdb_list": "",
            "find_pocket": True,
