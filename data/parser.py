...
class MMCIFParser:
    ...
    def make_indices(
        ...
        ligand_prot_filtered = [
            idx for idx in sample_indices_list
            if idx["type"] == "interface"
                and sorted([idx.get("mol_1_type"), idx.get("mol_2_type")]) == ["ligand", "prot"]
        ]  # 只返回ligand 与protein
            
        return ligand_prot_filtered
